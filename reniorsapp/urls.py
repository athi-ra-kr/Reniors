...
from .views import customer_portal
from .views import CustomerByMpinView

from django.urls import path, re_path, include
from rest_framework import permissions
from drf_yasg.views import get_schema_view
from drf_yasg import openapi
from reniorsapp.views import CustomerByMpinView  # adjust import

schema_view = get_schema_view(
    openapi.Info(
        title="Customer API",
        default_version="v1",
        description="Get customer details using MPIN",
    ),
    public=True,
...
urlpatterns = [
    ...
    path('customer_package_list/', views.customer_package_list, name='customer_package_list'),
    path('customer_package_add/', views.customer_package_add, name='customer_package_add'),
    path('edit/<int:pk>/', views.customer_package_edit, name='customer_package_edit'),
    path('delete/<int:pk>/', views.customer_package_delete, name='customer_package_delete'),
    ...
    path('api/customer/', CustomerByMpinView.as_view(), name='customer-by-mpin'),
